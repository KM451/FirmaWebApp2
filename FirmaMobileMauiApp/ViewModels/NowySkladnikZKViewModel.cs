...
{
    public class NowySkladnikZKViewModel: ANewItemViewModel<SkladnikZKForView>
    {
        ...
        public NowySkladnikZKViewModel() : base()
        {
        ...
        public override SkladnikZKForView SetItem() => new SkladnikZKForView()
        {
            Ilosc = Ilosc,
            CzyAktywny = true,
